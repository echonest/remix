...
class AudioAnalysis(track.Track) :
    ...
    def bars(self):
        if self._bars is None:
            self._bars = _dataParser('bar', super(AudioAnalysis, self).bars)
    ...
    def beats(self):
        if self._beats is None:
            self._beats = _dataParser('beat', super(AudioAnalysis, self).beats)
    ...
    def tatums(self):
        if self._tatums is None:
            self._tatums = _dataParser('tatum', super(AudioAnalysis, self).tatums)
    ...
    def sections(self):
        if self._sections is None:
            self._sections = _attributeParser('section', super(AudioAnalysis, self).sections)
    ...
    def segments(self):
        if self._segments is None:
            self._segments = _segmentsParser(super(AudioAnalysis, self).segments)
