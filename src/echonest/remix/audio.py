...
class AudioData(AudioRenderable):
    ...
    def add_at(self, time, another_audio_data):
        """
        Adds the input `another_audio_data` to this `AudioData` at the `time`
        specified in seconds. If `another_audio_data` has fewer channels than
        ...
        if another_audio_data.numChannels < self.numChannels:
            # resample another_audio_data's data and numChannels
